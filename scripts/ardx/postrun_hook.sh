...
DEFAULT_TOOLS=(
  ...
  Glob
  Grep
  'Bash(/home/shunsukenaito/.conda/envs/ard-v2/bin/python -m pytest *)'
  'Bash(/home/shunsukenaito/.conda/envs/ard-v2/bin/python -m ard.cli.status *)'
  'Bash(/home/shunsukenaito/.conda/envs/ard-v2/bin/python scripts/verify.py *)'
  'Bash(/home/shunsukenaito/.conda/envs/ard-v2/bin/python scripts/aggregate_*)'
  'Bash(PYTHONPATH=src /home/shunsukenaito/.conda/envs/ard-v2/bin/python -m pytest *)'
  'Bash(PYTHONPATH=src /home/shunsukenaito/.conda/envs/ard-v2/bin/python -m ard.cli.status *)'
  'Bash(PYTHONPATH=src /home/shunsukenaito/.conda/envs/ard-v2/bin/python scripts/verify.py *)'
  'Bash(PYTHONPATH=src /home/shunsukenaito/.conda/envs/ard-v2/bin/python scripts/aggregate_*)'
  'Bash(/home/shunsukenaito/.conda/envs/ard-v2/bin/python scripts/ardx/*)'
