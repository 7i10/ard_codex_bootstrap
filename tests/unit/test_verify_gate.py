...
def test_signal_audit_paths_select_only_the_focused_audit_test() -> None:
    ...
    assert logging_state.tests == ("tests/unit/test_logging_only_state.py",)
    assert logging_state.tiers == ("T0", "T1")

    logging_prediction = select(
        ("src/ard/analysis/logging_only_prediction.py", "src/ard/cli/logging_only_prediction.py"),
        (*available, "tests/unit/test_logging_only_prediction.py"),
    )
    assert logging_prediction.tests == ("tests/unit/test_logging_only_prediction.py",)
    assert logging_prediction.tiers == ("T0", "T1")

    history_screen = select(
        ("src/ard/analysis/history_screen.py", "src/ard/cli/history_screen.py"),
        (*available, "tests/unit/test_history_screen.py"),
    )
    ...
    pre39 = select(
        ("src/ard/analysis/pre39_prescriptive.py", "src/ard/cli/pre39_prescriptive.py"),
        (*available, "tests/unit/test_pre39_prescriptive.py"),
    )
    ...
    pre39_online = select(
        ...
        (*available, "tests/unit/test_pre39_online_state.py"),
    )
